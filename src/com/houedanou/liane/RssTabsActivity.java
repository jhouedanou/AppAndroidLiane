...
public class RssTabsActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		artIntent.putExtra("rss-url", "http://liane-ci.com/offres.xml");
		...
		techIntent.putExtra("rss-url", "http://liane-ci.com/rss-actus.xml");
		...
		sportsIntent.putExtra("rss-url", "http://liane-ci.com/base-de-donn-es-des-osc.xml");
